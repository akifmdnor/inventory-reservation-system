  ...
  return (
    <section className="relative overflow-hidden border-b border-iris-border bg-gradient-to-br from-teal-50 via-iris-surface to-zinc-50">
      ...
      <div className="relative mx-auto max-w-6xl px-4 py-14 sm:px-6 sm:py-20">
        <p className="text-xs font-semibold uppercase tracking-[0.2em] text-teal-700">Spring collection</p>
        ...
        <div className="mt-8 flex flex-wrap gap-3 text-xs font-medium text-iris-muted">
          <span className="rounded-full border border-iris-border bg-iris-surface px-3 py-1.5">Trusted checkout</span>
          <span className="rounded-full border border-iris-border bg-iris-surface px-3 py-1.5">Secure hold</span>
          <span className="rounded-full border border-iris-border bg-iris-surface px-3 py-1.5">4.9 store rating</span>
        </div>
      </div>
    </section>
  );
